				...
				<tbody>		
					<c:forEach items="${books}" var = "book">
						...
						<td> <!-- buttons for operations -->
							<a href="/books/delete/${book.isbn}" class="btn btn-outline-danger btn-sm"><b>Delete</b></a>
							<a href="/books/edit/${book.isbn}" class="btn btn-outline-success btn-sm"><b>Edit<b/></a>
						</tr> 
					</c:forEach>
				</tbody>
